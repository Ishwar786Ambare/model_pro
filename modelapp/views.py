...
def current_page(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            data.save()
            a=data.author = request.user
            print(a)

            qu = Customer.objects.all()
            print(qu.name)
            send_mail("Hi" + qu.name + "this is from NEXTCLICK",
                      "your" + qu.email + "is ready for dispatch\nthank you for your shopping|||", "ambareishu@gmail.com",
...
def mailsend(request):
    ...
    #           "ambareishu@gmail.com",
    #           ['ishwarambare@hotmail.com', 'ishwarambare@gmail.com'], fail_silently=False)
    # data = Customer.objects.filter(email=ishwarambre@gmil.com)
